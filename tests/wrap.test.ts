...
describe('extension_nft', () => {
  ...
  console.log("Asset PubKey = ", assetInfoAccountAddr.publicKey.toBase58())
  ...
  it('Mint NTF!', async () => {
    ...
    console.log('target token account = ', destinationTokenAccount.toBase58())

    getOrCreateAssociatedTokenAccount;
    const tx = await program.methods
      .mintNft(metadata.name, metadata.symbol, metadata.uri, assetInfoAccountAddr.publicKey.toBase58())
      .accounts({
